...
In order to implement these changes we have to create a new instance variable called count;
count will be a primitive int, and have the visibility of private.
The modification we will make to the CheckDigit class is that if the isValid method is about to return
false, we will increment count by 1 right before that happens. Everything else in the isValid method would remain the same.
